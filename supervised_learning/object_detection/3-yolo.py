...
class Yolo:
    ...
    def non_max_suppression(self, filtered_boxes, box_classes, box_scores):
        ...
        # Iterate through each unique class present in the filtered boxes
        for cls in np.unique(box_classes):
            ...
            # Indices of scores sorted in descending order
            ...
            while len(idxs) > 0:
                ...
                # Calculate IoU between the picked box and the rest
                rect1 = cls_boxes[current]
                rest = cls_boxes[idxs[1:]]

                # Coordinates of intersection rectangles
            ...
            # Add results for this class to global lists
