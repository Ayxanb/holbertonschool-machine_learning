...
class NeuralNetwork:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05):
        """
        Trains the neural network by updating private attributes.
        ...
        Returns:
            Evaluation (prediction, cost) after training.
        """
        ...
        for _ in range(iterations):
            # Forward pass to update self.__A1 and self.__A2
            self.forward_prop(X)
            # Update weights and biases based on current activations
