...
class Dataset:
    ...
    def encode(self, pt, en):
        ...
        Returns:
            pt_tokens, en_tokens: lists containing the Portuguese and
                English tokens, each including the start and end of
                sentence tokens (indexed vocab_size and vocab_size + 1
                respectively, for their own tokenizer's vocab_size).
        """
    ...
    def tf_encode(self, pt, en):
        ...
        Returns:
            pt_tokens, en_tokens: tensors containing the Portuguese
                and English tokens.
        """
